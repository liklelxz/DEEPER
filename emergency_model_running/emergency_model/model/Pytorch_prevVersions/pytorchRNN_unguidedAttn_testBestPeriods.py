...
dfResults = pd.read_csv(os.path.join(args.save_path,args.type_rnn,incident_group+"/LogResultsAttn.csv"))
...
dfResults.to_csv(os.path.join(args.save_path,args.type_rnn,incident_group+"/LogResultsAttn.csv"), index=False)
