...
parser.add_argument('--replace_median', type=int, default=1,
                    help='Flag to choose whether replace with median')
...
def csvfilter1(filepath, outpath, outpath_median,replace_median = 1, columns='TCRYWD', clasify="Incident Type", begindate="2011/05/04", enddate=None,
               Minrt=None,Minevent=None,Maxevent=1000,combination_1= None):
    ...
    qt09 = df["Response Time"].quantile(0.9)
    print qt09
    df["Response Time"].loc[df["Response Time"] >=qt09]=qt09
...
csvfilter1(filepath,outpath,outpath_median,replace_median,cl,clf,bd,ed,minr,mine,maxe,combine)
